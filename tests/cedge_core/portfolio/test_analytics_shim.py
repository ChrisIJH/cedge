...
class TestBackwardCompatImports:
    def test_policy_comparison_import(self):
        from cedge_core.portfolio.analytics import calc_stats, build_yearly_breakdown, build_cumulative
    ...
    def test_factor_portfolio_import(self):
        from cedge_core.portfolio.analytics import get_daily_prices, calc_return_stats, build_performance
